...
import com.aron.framedemo.util.NetUtil;
...
public class RetrofitManager {
    ...
    public RetrofitManager() {
        Retrofit retrofit = new Retrofit.Builder().baseUrl(Constant.NETEAST_HOST)
    ...
    public Observable<Map<String, NewsDetail>> getNewsDetailObservable(String postId) {
        return mService.getNewDetail(getCacheControl(), postId);
    }
    public Observable<ResponseBody> getNewsBodyHtmlPhoto(String photoPath) {
        return mService.getNewsBodyHtmlPhoto(photoPath);
    }
}

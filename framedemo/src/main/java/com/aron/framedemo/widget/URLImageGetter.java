 ...
 *
 */
package com.aron.framedemo.widget;
...
public class URLImageGetter implements Html.ImageGetter {
    ...
    private static final String mFilePath = BaseApplication.getAppContext().getCacheDir().getAbsolutePath();
    ...
    private Drawable getDrawableFromNet(final String source) {
        mSubscription = RetrofitManager.getInstance()
    ...
    private Drawable createPicPlaceholder() {
        ...
        drawable = new ColorDrawable(BaseApplication.getAppContext().getResources().getColor(color));
